! function() {
  ...
  var xmlHttp = new XMLHttpRequest();
        ...
        if (xmlHttp.readyState == 4 && xmlHttp.status == 200)
    {
      ...
      setInterval(function(){
        ...
        if (pageToken === "")
        {
          xmlHttp1.open("GET", "https://www.googleapis.com/youtube/v3/liveChat/messages?liveChatId=" + liveChatId + "&part=snippet&key=" + apiKey, true);
        }
        else
        {
  ...
  var res = linkyoutube.split("?v=");
    xmlHttp.open("GET", "https://www.googleapis.com/youtube/v3/videos?part=snippet%2CliveStreamingDetails&id=" + res[res.length - 1] + "&key=" + apiKey, true);
    xmlHttp.send(null);
